            ...
            <div className="w-full text-center lg:w-8/12">
              ...
              <div className="sm:block flex flex-col mt-10">
                <a
                  ...
                  target="_blank"
                  className="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-2 bg-gray-400 active:bg-gray-500 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                >
                  Get started
                </a>
                <a
